...
export const AboutSection = () => {
    ...
    return aboutMeSection?.designation ? <section id="about" className="py-24 px-4 relative">
        {" "}
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                {aboutMeSection?.designation && <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-6">
                    {aboutMeSection?.expertiseAndInterest && <div className="gradient-border p-6 card-hover">
                    ...
                    {aboutMeSection?.aboutYourRole && <div className="gradient-border p-6 card-hover">
                        <div className="flex items-start gap-4">
                            <div className="p-3 rounded-full bg-primary/10">
                    ...
                    {aboutMeSection?.managementExperience && <div className="gradient-border p-6 card-hover">
                        <div className="flex items-start gap-4">
                            <div className="p-3 rounded-full bg-primary/10">
